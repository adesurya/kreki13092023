abstract class AppValues {
  ...
  static const double marginSnapBottom = 114;
  ...
  static const double heightImageAuth = 120;
  static const double widthImageAuth = 150;

  static const double buttonHelpSize = 120;
  ...
  static const double iconHomeSize = 48;
  ...
  static const double heightContainerImage = 140;

  static const int citizenIdLength = 16;

  static const double ratioCertificate = 8.5/5.5;

  static const int phoneNumberMinLength = 11;
  static const int phoneNumberMaxLength = 13;

  static const double heightEmergencyButton = 54;

  static const int defaultByteData = 1024;

  static const double toolbarSpacing = 8;

  static const double minLeadingWidth = 60;

  static const double marginBottomMaps = 230;

  static const double minPanelHeight= 160;

  static const double defaultButtonHeight = 30;

  static const double grabbingHeight = 70;

  static const int maxCitizenIdLength = 16;
}

  ...
  contentWidget(){
    return Column(
      ...
      children: [
        ...
        Obx(()=>Text('Deskripsi: \n${controller.emergency.keterangan?? 'Tidak ada deskripsi'}' , style: cardSmallTagStyle,)),
        ...
        child: Column(
          children: [
            Stack(
              ...
              children: [
                const AssetImageView(fileName: 'ic_volunteer.svg')
                    .paddingRight(AppValues.smallPadding)
                    .paddingBottom(AppValues.smallPadding),

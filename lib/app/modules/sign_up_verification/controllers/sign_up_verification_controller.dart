...
class SignUpVerificationController extends BaseController {
  ...
  onPrepareSubmitData() async{
    ...
    if(formKey.currentState!.validate()){
      ...
      if(phoneNumberController.text.length< 10 || phoneNumberController.text.length > 14){
        showErrorMessage("no handphone antara 11-14 digit");
  ...
  _handleVerification(BaseResponse value)async{
    ...
    if(value.code! >= 200 && value.code! < 300 ){
      ...
      loadUserMobile(user.id.toString()).then((value) => Get.offAllNamed(Routes.MAIN, arguments: true));

...
EmergencyMobileEntity $EmergencyMobileEntityFromJson(Map<String, dynamic> json) {
	...
	final String? phoneNumber = jsonConvert.convert<String>(json['phoneNumberPasien']);
	if (phoneNumber != null) {
	...
	final List<dynamic>? relawan = jsonConvert.convertListNotNull<dynamic>(json['relawan']);
	if (relawan != null) {
	...
	final EmergencyMobileCreatedAt? createdAt = jsonConvert.convert<EmergencyMobileCreatedAt>(json['createdAt']);
	if (createdAt != null) {
	...
	final EmergencyMobileUpdateAt? updatedAt = jsonConvert.convert<EmergencyMobileUpdateAt>(json['updatedAt']);
	if (updatedAt != null) {
	...
	final double? latitudePasien = jsonConvert.convert<double>(json['latitudePasien']);
	if (latitudePasien != null) {
		emergencyMobileEntity.latitudePasien = latitudePasien;
	}
	final double? longitudePasien = jsonConvert.convert<double>(json['longitudePasien']);
	if (longitudePasien != null) {
		emergencyMobileEntity.longitudePasien = longitudePasien;
	}
	final EmergencyMobileStatus? status = jsonConvert.convert<EmergencyMobileStatus>(json['status']);
	if (status != null) {
	...
	final String? latitudeRelawan = jsonConvert.convert<String>(json['latitudeRelawan']);
	if (latitudeRelawan != null) {
		emergencyMobileEntity.latitudeRelawan = latitudeRelawan;
	}
	final String? longitudeRelawan = jsonConvert.convert<String>(json['longitudeRelawan']);
...
Map<String, dynamic> $EmergencyMobileEntityToJson(EmergencyMobileEntity entity) {
...
EmergencyMobileCreatedAt $EmergencyMobileCreatedAtFromJson(Map<String, dynamic> json) {
	final EmergencyMobileCreatedAt emergencyMobileCreatedAt = EmergencyMobileCreatedAt();
...
Map<String, dynamic> $EmergencyMobileCreatedAtToJson(EmergencyMobileCreatedAt entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
...
EmergencyMobileUpdateAt $EmergencyMobileUpdateAtFromJson(Map<String, dynamic> json) {
	final EmergencyMobileUpdateAt emergencyMobileUpdateAt = EmergencyMobileUpdateAt();
	final int? iSeconds = jsonConvert.convert<int>(json['_seconds']);
	if (iSeconds != null) {
...
Map<String, dynamic> $EmergencyMobileUpdateAtToJson(EmergencyMobileUpdateAt entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
	data['_seconds'] = entity.iSeconds;
	data['_nanoseconds'] = entity.iNanoseconds;
	return data;
...
EmergencyMobileStatus $EmergencyMobileStatusFromJson(Map<String, dynamic> json) {
...
Map<String, dynamic> $EmergencyMobileStatusToJson(EmergencyMobileStatus entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
